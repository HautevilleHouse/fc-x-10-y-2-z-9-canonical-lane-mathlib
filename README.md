# Generalized Fermat-Catalan (x^10+y^2=z^9) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Generalized Fermat-Catalan (x^10+y^2=z^9).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/fc-x-10-y-2-z-9-mathlib.git
cd fc-x-10-y-2-z-9-mathlib
lake exe
lake build
```
